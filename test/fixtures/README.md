...
Note: Go unit/interface test fixtures live in `testdata/` at the repository root (shared across Go packages). This directory is for the JavaScript test suites only.
